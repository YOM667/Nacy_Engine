...
namespace Nacy
{
    ...
    public:
        ...
        NACY_API void RenderText(std::string text, float x, float y, float scale, const RGBA& color);
        NACY_API void RenderCenterdText(std::string text, float x, float y, float scale, const RGBA& color);
